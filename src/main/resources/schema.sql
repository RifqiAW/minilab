...
CREATE TABLE IF NOT EXISTS mst_dealer(dealer_code VARCHAR(50) NOT NULL,dealer_name VARCHAR(255) NOT NULL, dealer_class VARCHAR(10) NOT NULL(dealer_class IN ('H123','H23')),telp_number VARCHAR(255) NOT NULL,alamat VARCHAR(512) NOT NULL,dealer_status VARCHAR(10) NOT NULL(dealer_status IN('ACTIVE','INACTIVE')),dealer_ext_code VARCHAR(50),PRIMARY KEY (dealer_code))
