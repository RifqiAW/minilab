...
insert into trx_order(order_id, unit_id, dealer_code, sales_id, customer_id, minimum_payment, total_value, order_value, offtheroad_value, order_total_discount, ppn, plat_nomor, nomor_mesin, nomor_rangka, is_leasing, payment_status, unit_status) values ('o1', '202203201010570000001', '100005', 'M1', 'c1', 5.0, 3.0, 2.0, 1.0, 6.0, 7.0, 'PL4T', '12', '11', null, 'FULLY_PAID', 'UNIT_RECEIVED');
